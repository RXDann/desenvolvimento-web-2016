...
Gist
 ...
 Watch 1
  Star 0
  Fork 3 desweb16/desenvolvimento-web-2016
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathdesenvolvimento-web-2016/grupo-academico/public_html/Grupo.php
32ae51c  35 minutes ago
@RXDann RXDann Alteração Grupo.php
3 contributors @Caio820 @desweb16 @RXDann
RawBlameHistory     
258 lines (194 sloc)  7.57 KB

<?php
$sql_code = "select id_notas , identificacao , notas , id_grupo from notas $pagina, $itens_por_pagina";
$execute = $mysqli->query($sql_code) or die($mysqli->error);
$produto = $execute ->fetch_assoc();
$num = $execute->num_rows;

$num_total = $mysqli->query("select id_notas , identificacao , notas , id_grupo from notas")->num_rows;
